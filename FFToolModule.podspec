...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/FelixZhengFei/FFToolModule.git", :tag => "1.1.3" }
  ...
  s.subspec 'FF_SliderView' do |ss|
    ss.source_files = "FFToolModule/FFToolModule/FF_SliderView/*.{h,m,swift}"
  end
